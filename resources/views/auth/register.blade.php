...
<div class="mx-auto max-w-md">
    <section class="page-card p-6 sm:p-8">
        ...
        <p class="mt-3 text-sm leading-7 text-slate-400">登録は任意です。現在このブラウザで持っているGuest計画も、そのまま新しいアカウントへ引き継ぎます。</p>
        ...
        <form method="POST" action="{{ route('auth.register') }}" class="mt-6 space-y-4">
            ...
            <button type="submit" class="btn-primary w-full">このデータを保護する</button>
        </form>
